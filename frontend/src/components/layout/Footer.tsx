        ...
        <div className={styles.topBar}>
          ...
          <Link href="/" className={styles.logoWrapper}>
            <span className={styles.logoText}>
              CAREER<span className={styles.logoHighlight}>CAMPUS</span>
            </span>
          </Link>

          {/* Horizontal Links */}
          <div className={styles.horizontalLinks}>
            <Link href="/" className={styles.horizontalLink}>Home</Link>
            <Link href="/colleges" className={styles.horizontalLink}>Colleges</Link>
            <Link href="/medicine" className={styles.horizontalLink}>Medical</Link>
            <Link href="/law" className={styles.horizontalLink}>Law</Link>
            <Link href="/compare" className={styles.horizontalLink}>Compare</Link>
            <Link href="/testimonials" className={styles.horizontalLink}>Reviews</Link>
            <Link href="/dashboard" className={styles.horizontalLink}>Dashboard</Link>
          </div>

          {/* Social Icons */}
          <div className={styles.socialIcons}>
            <a href="#" className={`${styles.socialIconBtn} ${styles.socialInsta}`}>
            ...
            <a href="#" className={`${styles.socialIconBtn} ${styles.socialYoutube}`}>
              <svg fill="currentColor" viewBox="0 0 24 24"><path d="M21.582 6.186c-.23-.86-.908-1.538-1.768-1.768C18.254 4 12 4 12 4s-6.254 0-7.814.418c-.86.23-1.538.908-1.768 1.768C2 7.746 2 12 2 12s0 4.254.418 5.814c.23.86.908 1.538 1.768 1.768C6.254 20 12 20 12 20s6.254 0 7.814-.418c.86-.23 1.538-.908 1.768-1.768C22 16.254 22 12 22 12s0-4.254-.418-5.814zM10 15.464V8.536L16 12l-6 3.464z"/></svg>
            </a>
            <a href="#" className={`${styles.socialIconBtn} ${styles.socialFacebook}`}>
            ...
            <a href="#" className={`${styles.socialIconBtn} ${styles.socialLinkedin}`}>
              <svg fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="#" className={`${styles.socialIconBtn} ${styles.socialX}`}>
              <span style={{fontWeight: 700, fontSize: '18px'}}>X</span>
            </a>
          </div>
        </div>
